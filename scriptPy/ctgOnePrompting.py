...
MODEL = "meta-llama/llama-4-maverick:free"  #"deepseek/deepseek-r1"   #"meta-llama/llama-4-maverick:free"  #"anthropic/claude-3.7-sonnet" #"google/gemini-2.0-flash-thinking-exp:free"  #"mistralai/mistral-small-3.1-24b-instruct:free" #"deepseek/deepseek-chat-v3-0324:free" #"deepseek/deepseek-r1:free"
...
def estimate_co2_for_product(product_data, llm_model=MODEL):
    ...
    prompt = f"""
    You are an expert in life cycle analysis (LCA), focusing specifically on cradle-to-gate assessment. 
    Calculate CO2e emissions in kg for the following product, considering ONLY these phases:
...
def main(num_rows):
    ...
    with open("cradle_to_gate_meta_llama4_maverick.json", "w", encoding="utf-8") as out:
